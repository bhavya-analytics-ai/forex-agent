...
- **In progress — 39 examples collected** (`docs/om_gold_scalp/OM_GOLD_SCALP_RULEBOOK.md`)
...
- All screenshot files committed — 5M batch `9793c93`, paired 1H/5M `f2c8b34`, news-displacement `ade3127`, range-break failed-reclaim `c015638`, countertrend-green-failure `5be702b`, decision-zone consolidation `b80e6ad`, impulse-exhaustion `29e94de`, HTF-range no-trade `5d055d4`
