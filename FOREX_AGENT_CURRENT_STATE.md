...
- **In progress — 27 examples collected** (`docs/om_gold_scalp/OM_GOLD_SCALP_RULEBOOK.md`)
...
- All screenshot files committed — 5M batch `9793c93`, paired 1H/5M `f2c8b34`
- Next planned: 028/029 (15M sweep reclaim → 5M long), 030/031 (15M chop/EMA conflict → 5M skip)
